...
# img = cv2.imread("pics/Corners_box_screenshot.png")
# img = cv2.imread("pics/cube_distance.jpg")
#img = cv2.imread("pics/powercube.jpg")
img = cv2.imread("pics/powercubes.jpg")
# img = cv2.imread("pics/cardboardbox.jpg")
# img = cv2.imread("pics/cube_obstructed.jpg")
